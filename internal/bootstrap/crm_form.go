...
func MeetingFields(contactEntityID, companyEntityID, dealEntityID string) []entity.Field {
	...
	attendessField := entity.Field{
		...
		DataType:    entity.TypeReference,
		RefID:       contactEntityID,
		Meta:        map[string]string{"display_gex": "uuid-00-email"},
		Field: &entity.Field{
			DataType: entity.TypeString,
			Key:      "id",
			Value:    "--",
	...
	companyField := entity.Field{
		...
		DataType:    entity.TypeReference,
		RefID:       companyEntityID,
		Meta:        map[string]string{"display_gex": "uuid-00-name", "row": "true"},
		Field: &entity.Field{
			DataType: entity.TypeString,
			Key:      "id",
			Value:    "--",
	...
	dealField := entity.Field{
		...
		DataType:    entity.TypeReference,
		RefID:       dealEntityID,
		Meta:        map[string]string{"display_gex": "uuid-00-deal-name", "row": "true"},
		Field: &entity.Field{
			DataType: entity.TypeString,
			Key:      "id",
			Value:    "--",
