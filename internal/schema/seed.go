...
INSERT INTO public.entities (entity_id, team_id, name, description, category, state, mode, retry, attributes, tags, created_at, updated_at) VALUES
	 ...
	 '[{"key": "` + SeedFieldKeyContactName + `", "display_name": "Name", "value": "", "hidden": false, "unique": false, "data_type": "S", "mandatory": false, "reference": ""}, {"key": "` + SeedFieldKeyContactEmail + `", "display_name": "Email", "value": "", "hidden": false, "unique": false, "data_type": "S", "mandatory": false, "reference": ""}, {"key": "` + SeedFieldKeyContactMRR + `", "display_name": "MRR", "value": "", "hidden": false, "unique": false, "data_type": "S", "mandatory": false, "reference": ""}, {"key": "` + SeedFieldKeyContactCompany + `", "display_name": "Company Name", "value": "", "hidden": false, "unique": false, "data_type": "S", "mandatory": false, "reference": ""}]', 
