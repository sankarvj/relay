module gitlab.com/vjsideprojects/relay
...
require (
	...
	github.com/ardanlabs/service v0.0.0-20191108204442-5b039bd4db61 // indirect
	...
	github.com/mailgun/mailgun-go/v4 v4.1.0 // indirect
